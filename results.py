...
if __name__ == '__main__':
    baseline_1 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_baseline_1/metrics_epoch200.csv', header=None)
    baseline_2 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_baseline_2/metrics_epoch200.csv', header=None)
    baseline_3 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_baseline_3/metrics_epoch200.csv', header=None)
    ...
    average_baseline = [(x + y + z) / 3 for x, y, z in zip(baseline_1, baseline_2, baseline_3)]
    # print(f'Baseline: {average_baseline[-1]}')

    texture_max_1 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_texture_1/metrics_epoch200.csv',
        header=None)
    texture_max_2 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_texture_2/metrics_epoch200.csv',
        header=None)
    texture_max_3 = pd.read_csv(
        '/Users/francescodifeola/Desktop/downloads_alvis/metrics_pix2pix_texture_3/metrics_epoch200.csv',
        header=None)
