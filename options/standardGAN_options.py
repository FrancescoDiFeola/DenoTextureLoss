...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--lambda_1", type=int, default=10, help="cycle reconstruction loss weight")
        parser.add_argument("--lambda_2", type=int, default=10, help="Self reconstruction loss weight")
        parser.add_argument("--lambda_3", type=int, default=1, help="Classification loss weight")
        parser.add_argument("--lambda_4", type=int, default=1, help="Adversarial loss weight")
        parser.add_argument("--lambda_texture", type=int, default=0.001, help="Texture loss weight")
        parser.add_argument("--lambda_percpetual", type=int, default=0.1, help="Perceptual loss weight")
